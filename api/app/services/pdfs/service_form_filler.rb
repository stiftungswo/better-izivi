...
>>>>>>> pdfGenerate:api/app/services/pdfs/service_form_filler.rb
    ...
    def load_service_date_fields
      convert_to_form_fields_hash(ServiceFormFields::SERVICE_DATE_FORM_FIELDS) do |key, value|
        [value, I18n.l(@service.public_send(key))]
      end
    end

    def load_service_checkboxes
      convert_to_form_fields_hash(ServiceFormFields::SERVICE_CHECKBOX_FIELDS) do |key, value|
