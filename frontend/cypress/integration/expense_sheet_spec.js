describe('ExpenseSheet form spec', () => {
  ...
  it('should have correct hints', () => {
    ...
    cy.get(':nth-child(13) > .col-md-9 > .input-group > .input-group-append > .input-group-text').contains('Vorschlag: 0 Tage');
    cy.get(':nth-child(14) > .col-md-9 > .input-group > .input-group-append > .input-group-text').contains('Vorschlag: 0 Tage');
