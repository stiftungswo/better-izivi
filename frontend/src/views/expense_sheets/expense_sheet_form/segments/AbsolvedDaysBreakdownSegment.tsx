  ...
  ({ hints, mainStore }: { hints: ExpenseSheetHints, mainStore: MainStore }) => (
      <>
        <WiredField
          ...
          appendedLabels={[
            mainStore.intl.formatMessage({
              id: 'izivi.frontend.views.expense_sheets.absolvedDaysBreakdownSegment.work_days_sugestion',
          ...
          label={
            mainStore.intl.formatMessage({
              id: 'izivi.frontend.views.expense_sheets.absolvedDaysBreakdownSegment.worked',
        ...
        <WiredField
          ...
          appendedLabels={[
            mainStore.intl.formatMessage({
              id: 'izivi.frontend.views.expense_sheets.absolvedDaysBreakdownSegment.free_days_suggestion',
          ...
          label={
            mainStore.intl.formatMessage({
              id: 'izivi.frontend.views.expense_sheets.absolvedDaysBreakdownSegment.workfree',
        ...
        <WiredField
          ...
          appendedLabels={[
            mainStore.intl.formatMessage({
              id: 'izivi.frontend.views.expense_sheets.absolvedDaysBreakdownSegment.remaining_sick_days',
          ...
          label={
            mainStore.intl.formatMessage({
              id: 'izivi.frontend.views.expense_sheets.absolvedDaysBreakdownSegment.sick',
